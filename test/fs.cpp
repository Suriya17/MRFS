...
int copy_pc2myfs (char *source, char *dest){
    ...
    for(int i=0;i< mySB->max_blocks;i++)
    {
        if(blocks_required==0) break;
        if(!mySB->bitmap[i]){
            free_data_block = (data_block *)(myfs + DATA_START+i*256);
            tmp = read(filefd,buf,BLOCK_SIZE);
            memcpy(free_data_block->data,buf,tmp);
            blocks_required--;
            free_block_num.push_back(i);
            mySB->bitmap[i] = 1;
           // cout << "used for file " << i << endl;
            mySB->used_blocks++;
        }
        
    }

   // cout << mySB->bitmap[43] << "at 43" << endl;
   ...
   // cout << mySB->bitmap[43] << "at 43" << endl;
    ...
    if(free_block_num.size()>8){
        ...
        //cout<<"indirect_tmp block: "<<indirect_tmp<<endl;
    ...
    if(free_block_num.size() > 72)
    {
        ...
        for(int i = 72; i <= free_block_num.size()-72;i++){
            if((i-72)%64 == 0){
...
int rm_myfs (char *filename){
    int tmp=search_fileinode(filename);
    if(tmp==-1)
    {
...
int main(){
    ...
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode2.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode3.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode4.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode5.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode6.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode7.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode8.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode9.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode10.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode11.cpp");
    copy_pc2myfs((char *)"fs.cpp",(char *)"mycode12.cpp");
    ls_myfs();
    ...
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    // ls_myfs();
    cout<<"Deleting mycode2.cpp \n";
    rm_myfs((char *)"mycode2.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    cout<<"Deleting mycode3.cpp \n";
    rm_myfs((char *)"mycode3.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode4.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode5.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode6.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode7.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode8.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode9.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode10.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode11.cpp");
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    rm_myfs((char *)"mycode12.cpp");

    ls_myfs();
    cout<<"No of blocks used : "<<mySB->used_blocks<<endl;
    for(int i=0;i<MAX_BLOCKS;i++)
    {
        if(mySB->bitmap[i]==1) cout<<i<<endl;
    }
}